...
export default function Hero() {
  ...
  return(
    <BackgroundWrapper 
      ...
      className="text-white flex justify-center items-end text-center h-[95svh] sm:h-[90vh] lg:h-screen overflow-hidden"
    >
    <div className="relative z-10 h-full flex flex-col justify-end items-center space-y-4 pb-7 sm:pb-10 fade-in">
      <div className="flex justify-center items-center gap-3 sm:gap-12 md:gap-20 lg:gap-32">
        <a href="https://emeraldfoundation.ca/emeraldawards/" target="_blank"><img src={award1} alt="28th-emerald-finalist" className="h-24 sm:h-44 award-shadow" /></a>
        <a href="https://emeraldfoundation.ca/emeraldawards/" target="_blank"><img src={award2} alt="30th-emerald-finalist" className="h-24 sm:h-44 award-shadow" /></a>
        <a href="https://emeraldfoundation.ca/emeraldawards/" target="_blank"><img src={award3} alt="31st-emerald-recipient" className="h-24 sm:h-44 award-shadow" /></a>
      </div>
